...
For this part we first have a more detailed description on how the COG hmm's were generated. You do not need to run this yourself but can start the analysis at the section ** Run COG search **

### Generate profiles using the NCBI 2020 set
...
- some of these sequences are reviewed (i.e. might have some more supporting info) and unreviewed (annotation only based on sequence similarity)
