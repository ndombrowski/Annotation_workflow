...
foreach $line (@in) {
    ...
    ($junk, $id,  $junk, $junk, $junk, $junk, $junk, $junk, $junk, $junk,$evalue,$bitscore) = split(/\t/, $line);
	...
	($junk,$junk,  $junk, $junk, $junk, $junk, $junk, $junk, $junk, $junk, $list_evalue, $list_bitscore) = split(/\t/,$dedupe{$id});
