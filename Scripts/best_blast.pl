...
foreach $line (@in) {
    ...
    ($id, $junk, $percent_identity, $junk, $junk, $junk, $junk, $junk, $junk, $junk, $evalue, $junk) = split(/\t/, $line);
	...
	($junk, $junk, $list_percent_identity, $junk, $junk, $junk, $junk, $junk, $junk, $junk, $list_evalue, $junk) = split(/\t/,$dedupe{$id});
